      ...
      <div className="flex flex-col justify-center w-screen h-screen max-w-2xl">
        <div className="flex flex-col justify-center items-start px-5">
          ...
          <p className="text-sm mt-6">
            After an assignment as UX/UI Designer of a company I found myself
            out looking for a new job. During my assignment I’d been working on
            this company’s website and app design. As I was looking for new jobs
            I realised that the market was tough so say the least and I needed
            to expand my own design portfolio in order to make myself an
            attractive designer for open positions.
          </p>
